...
<!-- Mirrored from akademi.dexignlab.com/xhtml/file-manager.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 14:04:13 GMT -->
<head>
		...
		<div class="content-body mh-auto">
            <div class="container-fluid p-0 mh-auto">
				<div class="card p-0 rounded-0 file_area mb-0">
					<div class="row gx-0">
						<!--column-->
						<div class="col-xl-2 col-xxl-3 col-lg-3 col-md-4">
							<div class="email-left-box border-end  dlab-scroll" id="email-left">
								<div class="p-0">
									<a href="email-compose.html" class="btn text-white btn-block"><i class="fa-solid fa-plus me-3"></i>Upload</a>
								</div>
						...
						<!--/column-->
						<!--column-->
						<div class="col-xl-10 col-xxl-9 col-lg-9 col-md-8">
							<!--row-->
							<div class="row  gx-0">
								<!--column-->
								<div class="col-xl-12">
									...
									<div class="file-header">
										<div class="card-body py-0">
											<div class="page-titles">
												<div class="my-2">
													<h2 class="heading">Recent Files</h2>
													<div class="file-path">
														<div class="me-2">
												...
												<div class="d-flex my-2">
													<div class="input-group search-area ">
														<input type="text" class="form-control" placeholder="Search here...">
														<span class="input-group-text"><a href="javascript:void(0)"><svg width="15" height="15" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
															<path d="M17.5605 15.4395L13.7527 11.6317C14.5395 10.446 15 9.02625 15 7.5C15 3.3645 11.6355 0 7.5 0C3.3645 0 0 3.3645 0 7.5C0 11.6355 3.3645 15 7.5 15C9.02625 15 10.446 14.5395 11.6317 13.7527L15.4395 17.5605C16.0245 18.1462 16.9755 18.1462 17.5605 17.5605C18.1462 16.9747 18.1462 16.0252 17.5605 15.4395V15.4395ZM2.25 7.5C2.25 4.605 4.605 2.25 7.5 2.25C10.395 2.25 12.75 4.605 12.75 7.5C12.75 10.395 10.395 12.75 7.5 12.75C4.605 12.75 2.25 10.395 2.25 7.5V7.5Z" fill="#01A3FF"></path>
														</svg>
															</a>
														</span>
								...
								<ul class="folder-structure dlab-scroll" id="folder">
									...
									<li>
										<div class="file-list">
											<div class="dz-media"> 
												<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path fill-rule="evenodd" clip-rule="evenodd" d="M39.984 19.984C39.984 30.832 31.36 39.664 20.592 39.968H19.472C8.672 39.68 0 30.848 0 19.968C0 9.088 8.656 0.272 19.456 0H20.576C31.36 0.32 39.984 9.136 39.984 19.984Z" fill="var(--primary)"/>
													<path fill-rule="evenodd" clip-rule="evenodd" d="M40.064 19.984C40.064 30.832 31.44 39.664 20.672 39.968H20.064V0H20.64C31.44 0.32 40.064 9.136 40.064 19.984Z" fill="var(--primary)"/>
									...
									<li>
										<div class="file-list">
											<div class="dz-media"> 
												<img class="dz-img" src="images/media-1.png" alt="">	
											</div>
											<div class="dz-info">
												<a href="#">
													<h4 class="title">Project 01</h4>
									...
									<li>
										<div class="file-list">
											<div class="dz-media"> 
												<img class="dz-img" src="images/media-2.png" alt="">	
											</div>
											<div class="dz-info">
												<a href="#">
													<h4 class="title">Project 01</h4>
									...
									<li>
										<div class="file-list">
											<div class="dz-media"> 
												<img class="dz-img" src="images/media-3.png" alt="">	
											</div>
											<div class="dz-info">
												<a href="#">
													<h4 class="title">Project 01</h4>
									...
									<li>
										<div class="file-list">
											<div class="dz-media"> 
												<img class="dz-img" src="images/media-4.png" alt="">	
											</div>
											<div class="dz-info">
												<a href="#">
													<h4 class="title">Project 01</h4>
							...
							<!--column-->
							<div class="col-xl-12">
								<div class="table-pagenation border-top">
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/file-manager.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 14:04:17 GMT -->
</html>