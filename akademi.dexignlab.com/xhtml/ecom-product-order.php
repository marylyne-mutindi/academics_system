...
<!-- Mirrored from akademi.dexignlab.com/xhtml/ecom-product-order.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 14:04:48 GMT -->
<head>
                        ...
                        <div class="card">
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table order-table table-sm mb-0">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody id="orders">
                                            ...
                                            <tr class="btn-reveal-trigger">
                                                ...
                                                <td class="py-2">
                                                    <a href="#">
                                                        <strong class="text-primary">#184</strong></a> by <strong class="text-priamry">Bucky
