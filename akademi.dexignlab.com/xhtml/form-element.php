...
<!-- Mirrored from akademi.dexignlab.com/xhtml/form-element.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 14:06:01 GMT -->
<head>
                                    ...
                                    <form>
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check d-inline-block mx-2">
                                                <label class="form-check-label">
                                                    <input type="checkbox" class="form-check-input me-2" value="">Option 2
                                                </label>
                                            </div>
                                    ...
                                    <form>
                                        <div class="mb-3 mb-0">
											...
											<div class="form-check custom-checkbox d-inline-block mb-2 mx-2">
												...
												<label class="form-check-label" for="customRadioBox8">Checkbox 2</label>
											</div>
											<div class="form-check custom-checkbox d-inline-block mb-2">
												<input type="radio" class="form-check-input" id="customRadioBox9" name="optradioCustom1">
												<label class="form-check-label" for="customRadioBox9">Checkbox 3</label>
											</div>
                                        </div>
                                    </form>
                                </div>
