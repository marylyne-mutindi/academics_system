...
<!-- Mirrored from akademi.dexignlab.com/xhtml/ecom-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 14:04:48 GMT -->
<head>
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="row align-items-center">
											<div class="col-sm-9"> 
												<div class="brand-logo mb-3">
													<img class="logo-abbr me-2 dark-logo" width="150" src="images/logo-full.png" alt="">
													<img class="logo-abbr me-2 light-logo" width="150" src="images/logo-white.png" alt="">
												</div>
                                    ...
                                    <table class="table table-invoice">
                                        <thead class="bg-primary">
                                            <tr>
                                                ...
                                                <th>Description</th>
                                                <th class="right text-white">Unit Cost</th>
                                ...
                                <div class="row">
                                    ...
                                    <div class=" col-xl-4 col-lg-5 col-md-6 col-sm-7 ms-auto">
                                        <table class="table table-clear">
                                            <tbody>
                                                <tr>
                                                    <td class="left"><strong class="text-primary">Subtotal</strong></td>
                                                    <td class="right">$8.497,00</td>
                                                </tr>
                                                <tr>
                                                    <td class="left"><strong class="text-primary">Discount (20%)</strong></td>
                                                    <td class="right">$1,699,40</td>
                                                </tr>
                                                <tr>
                                                    <td class="left"><strong class="text-primary">VAT (10%)</strong></td>
                                                    <td class="right">$679,76</td>
                                                </tr>
                                                <tr>
                                                    <td class="left"><strong class="text-primary">Total</strong></td>
                                                    <td class="right"><strong class="text-primary">$7.477,36</strong><br>
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/ecom-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 14:04:50 GMT -->
</html>