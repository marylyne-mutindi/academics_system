...
<!-- Mirrored from akademi.dexignlab.com/xhtml/food-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 14:04:08 GMT -->
<head>
						...
						<div class="card">
							<div class="card-body">
								<ul class="d-sm-flex d-block align-items-start justify-content-between mb-5">
									<li class="food-media">
										<img src="images/food/pic6.jpg" class="rounded" alt="">
									</li>
						...
						<div class="card h-auto">
							<div class="card-body">
								<div class="stud-comment">
									...
									<ul class="d-flex align-items-center">
										<li><img src="images/avatar/1.png" class="avatar" alt=""></li>
										<li class="ms-3">
						...
						<div class="card h-auto">
							<div class="card-body">
								<div class="stud-comment">
									...
									<ul class="d-flex align-items-center">
										<li><img src="images/avatar/2.png" class="avatar" alt=""></li>
										<li class="ms-3">
						...
						<div class="card h-auto">
							<div class="card-body">
								<div class="stud-comment">
									...
									<ul class="d-flex align-items-center">
										<li><img src="images/avatar/3.png" class="avatar" alt=""></li>
										<li class="ms-3">
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/food-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 14:04:13 GMT -->
</html>