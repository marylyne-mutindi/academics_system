...
<!-- Mirrored from akademi.dexignlab.com/xhtml/ecom-product-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 14:04:41 GMT -->
<head>
                                ...
                                <div class="row m-b-30">
                                    ...
                                    <div class="col-md-7 col-xxl-12">
                                        <div class="new-arrival-content position-relative">
                                            <h4><a href="ecom-product-detail.html">Blue blazers for girls School Uniform</a></h4>
                                            ...
                                            <p><span class="item fs-14">Availability:</span> In stock <i class="fa fa-check-circle text-success"></i></p>
                                            <p><span class="item fs-14">Product code:</span> 0405689 </p>
                                            <p><span class="item fs-14">Brand: </span>Lee</p>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row m-b-30">
                                    ...
                                    <div class="col-md-7 col-xxl-12">
                                        <div class="new-arrival-content position-relative">
                                            <h4><a href="ecom-product-detail.html">Maison d'éducation French School Dress</a></h4>
											<div class="comment-review star-rating">
                                                <ul>
                                                    <li><i class="fa fa-star"></i></li>
                                                    <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row m-b-30">
                                    ...
                                    <div class="col-md-7 col-xxl-12">
                                        <div class="new-arrival-content position-relative">
                                            <h4><a href="ecom-product-detail.html">Skirt for School kids School Uniform</a></h4>
                                            <div class="comment-review star-rating">
                                                <ul>
                                                    <li><i class="fa fa-star"></i></li>
                                                    <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row m-b-30">
                                    ...
                                    <div class="col-md-7 col-xxl-12">
                                        <div class="new-arrival-content position-relative">
                                            <h4><a href="ecom-product-detail.html">Girl with books Indian School uniform</a></h4>
                                            <div class="comment-review star-rating">
                                                <ul>
                                                    <li><i class="fa fa-star"></i></li>
                                                    <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row m-b-30">
                                    ...
                                    <div class="col-md-7 col-xxl-12">
                                        <div class="new-arrival-content position-relative">
                                            <h4><a href="ecom-product-detail.html">Skirt for School kids USA Uniform </a></h4>
                                            <div class="comment-review star-rating">
                                                <ul>
                                                    <li><i class="fa fa-star"></i></li>
                                                    <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row m-b-30">
                                    ...
                                    <div class="col-md-7 col-xxl-12">
                                        <div class="new-arrival-content position-relative">
                                            <h4><a href="ecom-product-detail.html">Back Bag Kid Uniform</a></h4>
                                            <div class="comment-review star-rating">
                                                <ul>
                                                    <li><i class="fa fa-star"></i></li>
                                                    <li><i class="fa fa-star"></i></li>
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/ecom-product-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 14:04:43 GMT -->
</html>