...
<!-- Mirrored from akademi.dexignlab.com/xhtml/user.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 14:04:17 GMT -->
<head>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
				<svg class="logo-abbr" width="48" height="54" viewBox="0 0 48 54" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<div class="d-flex justify-content-between">
									<div class="user">
										<div class="user-media">
											<img src="images/avatar/10.jpg" alt="" class="avatar avatar-xxl">
										</div>
										<div>
						...
						<div class="row">
								...
								<div class="card">
										...
										<div class="contacts-list"  id="RecentActivityContent">
											<div class="d-flex justify-content-between mb-3 mt-3 pb-3 user border-bottom">
												<div class="d-flex align-items-center">
													...
													<div class="ms-3">
														<h5 class="mb-1"><a href="app-profile.html">Samanta William</a></h5>
											...
											<div class="d-flex justify-content-between mb-3 mt-3 pb-3 user border-bottom">
												<div class="d-flex align-items-center">
													...
													<div class="ms-3">
														<h5 class="mb-1"><a href="app-profile.html">Tony Soap</a></h5>
														<span class="fs-14 text-muted">Class VII-A</span>
													</div>
												</div>	
												<div class="icon-box st-box ms-auto">
											...
											<div class="d-flex justify-content-between mb-3 mt-3 pb-3 user border-bottom">
												<div class="d-flex align-items-center">
													...
													<div class="ms-3">
														<h5 class="mb-1"><a href="app-profile.html">Karen Hope</a></h5>
														<span class="fs-14 text-muted">Class VII-A</span>
													</div>
												</div>	
												<div class="icon-box st-box ms-auto">
											...
											<div class="d-flex justify-content-between mb-3 mt-3 pb-3 user border-bottom">
												<div class="d-flex align-items-center">
													...
													<div class="ms-3">
														<h5 class="mb-1"><a href="app-profile.html">Jordan Nico</a></h5>
											...
											<div class="d-flex justify-content-between mb-3 mt-3 pb-3 user border-bottom">
												<div class="d-flex align-items-center">
													...
													<div class="ms-3">
														<h5 class="mb-1"><a href="app-profile.html">Nadila Adja</a></h5>
									...
									<div class="card-footer border-0 pt-0">
										<div class="text-center border-0 pt-3">
											<a href="javascript:void(0);" class="btn btn-block btn-primary light btn-rounded dz-load-more" id="RecentActivity" rel="ajax/message.html">View More</a>
										</div>
									</div>
								</div>
							</div>
							<div class="col-xl-6 col-lg-6 col-md-12">
								<div class="card">
										...
										<div class="contacts-list" id="RecentMessagesContent">
											<div class="d-flex justify-content-between mb-3 mt-3 border-bottom pb-3">
												<div class="d-flex align-items-center">
													<img src="images/profile/small/pic4.jpg" alt="" class="avatar">
													<div class="ms-3">
														<h5 class="mb-1"><a href="email-inbox.html">Samantha William</a></h5>
											...
											<div class="d-flex justify-content-between mb-3 mt-3 border-bottom pb-3">
												<div class="d-flex align-items-center">
													<img src="images/profile/small/pic1.jpg" alt="" class="avatar">
													<div class="ms-3">
														<h5 class="mb-1"><a href="email-inbox.html">Tony Soap</a></h5>
														<span class="fs-14 text-muted text-wrap">Lorem ipsum dolor sit amet...</span>
													</div>
												</div>	
												<div class="text-end">
											...
											<div class="d-flex justify-content-between mb-3 mt-3 border-bottom pb-3">
												<div class="d-flex align-items-center">
													<img src="images/profile/small/pic2.jpg" alt="" class="avatar">
													<div class="ms-3">
														<h5 class="mb-1"><a href="email-inbox.html">Jordan Nico</a></h5>
														<span class="fs-14 text-muted text-wrap">Lorem ipsum dolor sit amet...</span>
													</div>
												</div>	
												<div class="text-end">
											...
											<div class="d-flex justify-content-between mb-3 mt-3 border-bottom pb-3">
												<div class="d-flex align-items-center">
													<img src="images/profile/small/pic3.jpg" alt="" class="avatar">
													<div class="ms-3">
														<h5 class="mb-1"><a href="email-inbox.html">Karen Hope</a></h5>
														<span class="fs-14 text-muted text-wrap">Lorem ipsum dolor sit amet...</span>
													</div>
												</div>	
												<div class="text-end">
									...
									<div class="card-footer border-0 pt-0">
										<div class="text-center border-0 pt-3">
											<a href="javascript:void(0);" class="btn btn-block btn-primary light btn-rounded dz-load-more" id="RecentMessages" rel="ajax/contacts.html">View More</a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="dz-scroll">
									<ul class="timeline-active">
										<li class="d-flex timeline-list">
											<div class="dz-media">
												<img src="images/profile/14.jpg" alt="" class="avatar avatar-sm">
											</div>
											<div class="panel">
										...
										<li class="d-flex timeline-list">
											<div class="dz-media">
												<img src="images/profile/18.jpg" alt="" class="avatar avatar-sm">
											</div>
											<div class="panel">
												<a class="timeline-panel text-muted d-flex align-items-center mb-0" href="#">
										...
										<li class="d-flex timeline-list">
											<div class="dz-media">
												<img src="images/profile/19.jpg" alt="" class="avatar avatar-sm">
											</div>
											<div class="panel">
												<a class="timeline-panel text-muted d-flex align-items-center mb-0" href="#">
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/user.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 14:04:24 GMT -->
</html>