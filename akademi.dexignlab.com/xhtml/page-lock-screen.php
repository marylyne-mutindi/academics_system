...
<!-- Mirrored from akademi.dexignlab.com/xhtml/page-lock-screen.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 14:06:34 GMT -->
<head>
	<meta charset="utf-8">
					...
					<div class="row no-gutters">
						<div class="col-xl-12 tab-content">
							<div id="sign-up" class="auth-form tab-pane fade show active  form-validation">
								<form action="https://akademi.dexignlab.com/xhtml/index.html">
									<div class="text-center mb-4">
										<h3 class="text-center mb-2 text-black">Account Locked</h3>
									...
									<div class="mb-3">
										<label for="exampleFormControlInput2" class="form-label mb-2 fs-13 label-color font-w500">Password</label>
