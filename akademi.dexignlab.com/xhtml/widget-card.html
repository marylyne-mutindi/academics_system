...
<!-- Mirrored from akademi.dexignlab.com/xhtml/widget-card.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 14:05:59 GMT -->
<head>
	<!-- All Meta -->
	<meta charset="utf-8">
        ...
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="row">
					...
					<div class="col-xl-3 col-xxl-3 col-sm-6">
						<div class="card counter">
							<div class="card-body d-flex align-items-center p-4">
								...
								<div  class="">
									<h2 class="font-w600 1h-1 mb-0">932</h2>
									<p class="mb-0"> 
										Project
									</p>
								</div>
					...
					<div class="col-xl-3 col-xxl-3 col-sm-6">
						<div class="card counter">
							<div class="card-body d-flex align-items-center p-4">
								...
								<div>
									<h2 class="font-w600 lh-1 mb-0">1,032</h2>
									<p class="mb-0">
										Inquiries
									</p>
								</div>
					...
					<div class="col-xl-3 col-xxl-3 col-sm-6">
						<div class="card counter">
							<div class="card-body d-flex align-items-center p-4">
								...
								<div>
									<h2 class="font-w600 1h-1 mb-0">102k</h2>
									<p class="mb-0">
										Investment
									</p>
								</div>
					...
					<div class="col-xl-3 col-xxl-3 col-sm-6">
						<div class="card counter">
							<div class="card-body d-flex align-items-center p-4">
								...
								<div>
									<h2 class="font-w600 1h-1 mb-0">32k</h2>
									<p class="mb-0">
										Assets
									</p>
								</div>
							...
							<div class="card-body  p-4">
								<div class="media">
									...
									<div class="media-body text-white text-end">
										<p class="mb-1 text-white">Appointment</p>
						...
						<div class="widget-stat card bg-success">
							<div class="card-body p-4">
								<div class="media">
									...
									<div class="media-body text-white text-end">
										<p class="mb-1 text-white">Earning</p>
						...
						<div class="widget-stat card bg-primary">
							<div class="card-body p-4">
								<div class="media">
									...
									<div class="media-body text-white text-end">
										<p class="mb-1 text-white">Chef</p>
										<h3 class="text-white">$76</h3>
									</div>
								</div>
							</div>
						...
						<div class="widget-stat card bg-danger ">
							<div class="card-body p-4">
								<div class="media">
									...
									<div class="media-body text-white">
										<p class="mb-1 text-white">Fees Collect</p>
					...
					<div class="col-xl-4 col-lg-12 col-sm-12">
						<div class="card overflow-hidden">
							<div class="text-center p-5 overlay-box" style="background-image: url(images/big/rainbow.gif); background-size:cover;	" >
								<img src="images/profile/pic2.jpg" width="100" class="img-fluid rounded-circle" alt="">
								<h3 class="mt-3 mb-0 text-white">James Sena</h3>
							</div>
                            <div class="card-body">
								<div class="row text-center">
									<div class="col-6">
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/widget-card.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 14:06:01 GMT -->
</html>