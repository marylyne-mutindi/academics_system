...
<!-- Mirrored from akademi.dexignlab.com/xhtml/table-bootstrap-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 14:06:27 GMT -->
<head>
							...
							<div class="row">
								...
								<div class="col-xl-12">
									<div class="card" id="bootstrap-table1">
										<div class="card-header flex-wrap border-0 px-3">
											<div>
...
&lt;/div&gt;
						...
						<!-- Column starts -->
						<div class="col-xl-12">
							<div class="card" id="bootstrap-table3">
								<div class="card-header flex-wrap d-flex justify-content-between  border-0 px-3">
									<div>
...
&lt;/div&gt;
					...
					<!-- Column starts -->
                    <div class="col-xl-12">
                        <div class="card" id="bootstrap-table5">
                            <div class="card-header flex-wrap d-flex justify-content-between  border-0 px-3">
								<div>
...
&lt;/div&gt;
					...
					<div class="col-xl-12">
                        <div class="card" id="bootstrap-table15">
                            <div class="card-header flex-wrap d-flex justify-content-between  border-0 px-3">
								<div>
...
&lt;/div&gt;
					...
					<div class="col-xl-12">
                        <div class="card" id="bootstrap-table7">
                            <div class="card-header flex-wrap d-flex justify-content-between  border-0 px-3">
								<div>
...
&lt;/div&gt;
                    ...
                    <div class="col-xl-12">
                        <div class="card" id="bootstrap-table6">
							...
							<div class="tab-content" id="myTabContent-5">
								<div class="tab-pane fade show active" id="widthicon-2" role="tabpanel" aria-labelledby="home-tab-5">
									<div class="card-body p-0">
										<div class="table-responsive">
											<table class="table table-bordered table-responsive-sm">
												<thead>
								...
								<div class="tab-pane fade" id="widthicon-html-2" role="tabpanel" aria-labelledby="home-tab-5">
									<div class="card-body pt-0 p-0 code-area">
<pre class="mb-0"><code class="language-html">
&lt;div class="table-responsive"&gt;
&lt;table class="table table-bordered table-responsive-sm"&gt;
...
&lt;/div&gt;	
					...
					<!-- Column starts -->
                    <div class="col-xl-12">
                        <div class="card" id="bootstrap-table8">
                            <div class="card-header flex-wrap d-flex justify-content-between px-3">
								<div>
...
&lt;div class="table-responsive"&gt;
					...
					<!-- Column starts -->
                    <div class="col-xl-12">
                        <div class="card"  id="bootstrap-table10">
                            <div class="card-header flex-wrap d-flex justify-content-between px-3">
								<div>
...
&lt;/div&gt;	
                    ...
                    <!-- Column starts -->
                    <div class="col-xl-12">
                        <div class="card" id="bootstrap-table11">
                            <div class="card-header flex-wrap d-flex justify-content-between  border-0 px-3">
								<div>
...
&lt;/div&gt;
					...
					<!-- Column starts -->
                    <div class="col-xl-12">
                        <div class="card" id="bootstrap-table12">
                            <div class="card-header flex-wrap d-flex justify-content-between  border-0 px-3">
								<div>
...
&lt;/div&gt;</code></pre>
                    ...
                    <!-- Column starts -->
                    <div class="col-xl-12">
                        <div class="card" id="bootstrap-table13"> 
                            <div class="card-header flex-wrap d-flex justify-content-between  border-0 px-3">
								<div>
...
&lt;/div&gt;
					...
					<div class="col-xl-12">
                        <div class="card" id="bootstrap-table14"> 
                            <div class="card-header flex-wrap d-flex justify-content-between  border-0 px-3">
								<div>
							...
							<div class="demo-right-inner" id="right-sidebar">
								...
								<div class="dz-scroll demo-right-tabs" id="rightSidebarScroll">
									<ul class="navbar-nav nav" id="menu-bar">
										...
										<li><a href="#bootstrap-table8" 	class="scroll ">Bordered Table</a></li>
										<li><a href="#bootstrap-table9" 	class="scroll ">Table Stripped</a></li>
										<li><a href="#bootstrap-table10" 	class="scroll ">Responsive Table</a></li>
										<li><a href="#bootstrap-table11" 	class="scroll ">Heading With Background</a></li>
										<li><a href="#bootstrap-table12" 	class="scroll ">Primary Table</a></li>
										<li><a href="#bootstrap-table13" 	class="scroll ">Primary Table Hover</a></li>
										<li><a href="#bootstrap-table14" 	class="scroll ">Contextual Table</a></li>
